...
# modified imports to reflect project directory structure
import wolframalpha.six
from wolframalpha.six.moves import queue, xrange as range

import wolframalpha.inflect
from wolframalpha.more_itertools import more
from wolframalpha.more_itertools import recipes
...
class iterable_test(dict):
	...
	True
	"""
	def __init__(self, ignore_classes=wolframalpha.six.string_types+(wolframalpha.six.binary_type,)):
...
def always_iterable(item):
	...
	if item is None:
		item = ()
	singleton = (
		isinstance(item, wolframalpha.six.string_types)
